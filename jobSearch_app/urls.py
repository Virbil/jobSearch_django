...
urlpatterns = [
    ...
    path('interview_helper/<int:user_id>/<str:info_provided>/update/<int:id>', views.interview_helper_info_update),
    path('interview_helper/<int:user_id>/<str:info_provided>/delete/<int:id>', views.interview_helper_info_delete),
]